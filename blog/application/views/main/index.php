<header class="masthead" style="background-image: url('/public/images/home23.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Project</h1>
                    <span class="subheading">Blog in PHP</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <?php else: ?>
                <?php foreach ($list as $val): ?>
                    <div class="post-preview">
                        ...
                        <p class="post-meta">Post id <?php echo $val['id']; ?></p>
                    </div>
                    <hr>
                <?php endforeach; ?>
                <div class="clearfix">
